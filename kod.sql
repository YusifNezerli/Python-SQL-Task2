...
inner join Salesman on Customer.customer_id = Customer.salesman_id

select Customer.cust_name, Customer.city, Customer.grade, Salesman.city  from Customer inner join Salesman
order by customer_id ASC;

select Customer.cust_name, Customer.city, Salesman.commission  from Customer inner join Salesman
where commission between 0.13 and 0.20